...
function createField(Field, config) {
  var FieldWithContext = function FieldWithContext(props) {
    ...
    var _ref = config || {},
        ...
        defaultFormItemProps = _objectWithoutProperties(_ref, ["valueType", "customLightMode", "lightFilterLabelFormatter", "valuePropName", "defaultProps"]);
    ...
    var _defaultProps$props = _objectSpread(_objectSpread({}, defaultProps), props),
        ...
        rest = _objectWithoutProperties(_defaultProps$props, ["label", "tooltip", "placeholder", "width", "proFieldProps", "bordered", "messageVariables", "ignoreFormItem", "transform", "readonly", "allowClear", "colSize", "formItemProps"]);
    /** 从 context 中拿到的值 */
    ...
    , _extends({}, rest, {
      fieldProps: (0, _proUtils.omitUndefined)(_objectSpread(_objectSpread({
        ...
        }, "pro-field-".concat(width), width && WIDTH_SIZE_ENUM[width]))
      })),
