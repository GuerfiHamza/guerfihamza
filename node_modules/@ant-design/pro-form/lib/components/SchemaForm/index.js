...
function BetaSchemaForm(props) {
  ...
  var genItems = (0, _react.useCallback)(function (items, update) {
    return items.sort(function (a, b) {
    ...
    }).map(function (newItem, index) {
      var _item$dataIndex;

      var title = (0, _proUtils.runFunction)(newItem.title, 'form');
      var item = (0, _proUtils.omitUndefined)({
        name: newItem.name,
        valueType: (0, _proUtils.runFunction)(newItem.valueType, {}),
        key: newItem.key,
        columns: newItem.columns,
        fieldProps: (0, _proUtils.runFunction)(newItem.fieldProps, formRef.current, newItem),
        valueEnum: newItem.valueEnum,
        dataIndex: newItem.key || newItem.dataIndex,
        initialValue: newItem.initialValue,
        formItemProps: (0, _proUtils.runFunction)(newItem.formItemProps, formRef.current, newItem),
        width: newItem.width,
      ...
      var defaultRender = function defaultRender() {
        return /*#__PURE__*/_react.default.createElement(_index.ProFormField, formFieldProps);
      };

      if (item === null || item === void 0 ? void 0 : item.renderFormItem) {
        var _item$renderFormItem;

        var formDom = item === null || item === void 0 ? void 0 : (_item$renderFormItem = item.renderFormItem) === null || _item$renderFormItem === void 0 ? void 0 : _item$renderFormItem.call(item, _objectSpread({
          type: type
      ...
      return /*#__PURE__*/_react.default.createElement(_index.ProFormField, _extends({}, formFieldProps, {
        ...
        renderFormItem: (item === null || item === void 0 ? void 0 : item.renderFormItem) ? function (_, config) {
          ...
          return item === null || item === void 0 ? void 0 : (_item$renderFormItem2 = item.renderFormItem) === null || _item$renderFormItem2 === void 0 ? void 0 : _item$renderFormItem2.call(item, _objectSpread({
            type: type
          }, item), _objectSpread(_objectSpread({}, config), {}, {
            defaultRender: defaultRender,
            type: type
          }), formRef.current);
        } : undefined
